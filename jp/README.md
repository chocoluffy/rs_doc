...
[Unity SDKをこちらでダウンロード](https://reborn-dev.oss-cn-zhangjiakou.aliyuncs.com/4T2M2QiR/RebornSDK_1_6_0.unitypackage), Unityのバージョン要件は2022.3.8以上で、新しいURPプロジェクトを作成してください。
